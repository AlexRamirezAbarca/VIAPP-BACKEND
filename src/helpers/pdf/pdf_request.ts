...
import { GetRequestI } from "../../modules/requests/models";
...
export const pdfRequest = async (payload: GetRequestI, templateReport: string, res: Response, req: Request) => {

  if (!payload) return undefined
  payload.request.formatted_date = generalHelper.formatDate();
